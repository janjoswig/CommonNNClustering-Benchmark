...
if __name__ == "__main__":
    ...
    unit = base.BMUnit(
        ...
        setup_kwargs={"recipe": "distances", "prep": "pass"},
        timed_args=(
    ...
    report_dir = repo_dir / f"reports_unit/{args.machine}/no_structure/commonnn__fit/distances"
    if not report_dir.is_dir():
        report_dir.mkdir(parents=True, exist_ok=True)

    if args.profile:
        # report_file = report_dir / f"{args.identifier}{args.part}_profile.json"
        print("Profiling ...")
